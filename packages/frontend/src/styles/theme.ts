export const theme = {
  ...
  alert: {
    success: "rounded-2xl border border-primary-200 bg-primary-50 px-4 py-3 text-sm text-primary-700",
    error: "rounded-2xl border border-rose-200 bg-rose-50 px-4 py-3 text-sm text-rose-600",
  },
};
