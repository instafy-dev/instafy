# Learning policy (pinned)

Never prune: yes

This file defines when the Agent should create learnings and how `/learn` should shape them.
...
- Use the smallest relevant skill set and stop reading once you can act safely.
