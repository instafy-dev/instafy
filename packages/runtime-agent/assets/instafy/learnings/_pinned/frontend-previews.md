...
- Expose the preview port via an Instafy tunnel when possible.
...
6. Post the preview URL in chat. If the client supports it, suggest opening in a new tab (and provide a QR if available).
