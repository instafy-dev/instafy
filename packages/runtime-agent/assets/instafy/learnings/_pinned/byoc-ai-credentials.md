...
1) Ask a high-level question only if needed:
   - “Are you on mobile web, desktop web, the Instafy desktop app, or the VS Code extension?”
2) Point them to the best available connect path:
   ...
   - **VS Code extension**: use **“Connect with VS Code”** (runs `codex login` locally and uploads credentials).
