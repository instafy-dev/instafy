...
test("resolveDesktopDeepLinkTargetUrl rejects production controller credential overrides", () => {
  assert.equal(
    resolveDesktopDeepLinkTargetUrl(
  ...
  assert.equal(
    ...
    "http://127.0.0.1:5173/studio?controllerAccessToken=local-harness-token",
  );
});
